...
import br.org.ciag.fakestore.domain.Order;
import br.org.ciag.fakestore.domain.enumeration.OrderStatus;
import br.org.ciag.fakestore.repository.OrderRepository;
...
class OrderResourceIT {
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.status(UPDATED_STATUS).totalAmount(UPDATED_TOTAL_AMOUNT);
